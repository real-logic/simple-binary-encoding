...
import static uk.co.real_logic.sbe.generation.python.RustUtil.indent;
import static uk.co.real_logic.sbe.generation.python.RustUtil.rustTypeName;

class SubGroup implements RustPythonGenerator.ParentDef
{
        ...
        final int index) throws IOException
    {
        ...
        RustPythonGenerator.appendImplEncoderForComposite(sb, level - 1, name);
        ...
        RustPythonGenerator.generateEncoderFields(sb, fields, level);
        RustPythonGenerator.generateEncoderGroups(sb, groups, level, this);
        RustPythonGenerator.generateEncoderVarData(sb, varData, level);
        ...
        final int index) throws IOException
    {
        ...
        RustPythonGenerator.appendImplDecoderForComposite(sb, level - 1, name);

        // define impl...
        indent(sb, level - 1, "impl<P> %s<P> where P: Decoder + Default {\n", name);
        ...
        RustPythonGenerator.generateDecoderFields(sb, fields, level);
        RustPythonGenerator.generateDecoderGroups(sb, groups, level, this);
        RustPythonGenerator.generateDecoderVarData(sb, varData, level, true);
